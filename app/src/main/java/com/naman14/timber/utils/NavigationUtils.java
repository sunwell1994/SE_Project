...
import com.naman14.timber.activities.RegisterActivity;
import com.naman14.timber.activities.SearchActivity;
import com.naman14.timber.activities.SettingsActivity;
import com.naman14.timber.activities.UserProfileActivity;
...
public class NavigationUtils {
    ...
    //call for map
    public static void navigateToMap(Activity context) {
        final Intent intent = new Intent(context, LocationFilter.class);
     //   intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    public static void navigateToRegisterActivity(Context context) {
        ...
        intent.setAction(Constants.NAVIGATE_Register);
        context.startActivity(intent);
    }

    public static void navigateToLoginActivity(Context context) {
        Intent intent = new Intent(context, LoginActivity.class);
        intent.setAction(Constants.NAVIGATE_Login);
        context.startActivity(intent);
    }
